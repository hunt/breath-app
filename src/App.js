...
export default function App() {
  return (
    <div className="App">
      <a href="#6,0,6,0" alt="หายใจเข้า 6 วินาที / ออก 6 วินาที">
        Basic Breathing
      </a>{' '}
      |{' '}
      <a
      ...
      <br />
      ร่วมพูดคุยกันต่อในกรุ๊ป:{' '}
      <a
        href="https://www.facebook.com/groups/justbreathe.fit"
        alt="ร่วมพูดคุยกันต่อในกรุ๊ป: หายใจเป็น 'เป็นยา'"
      >
        หายใจเป็น "เป็นยา"
      </a>
